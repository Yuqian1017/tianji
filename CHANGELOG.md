...
## 2026-07-18 (续八) - 完成《医学衷中参西录》256 段显式引文校勘

- 对 `48-医家-衷中参西录要义.md` 抽取 256 段显式引文：75 段原字符、69 段规范化、5 段省略分段命中，107 段人工形态裁决；另有 13 段机械命中兼特殊归属裁决，待人工 0；4,591 项审计 0 fail。
...
- **review**: 策划案 fresh-context 自审 PASS-WITH-FIXES → 2 P0（§4 捏造引文——凭 handoff 转述未回读原文，红线 #9 违例实录）+ 4 P1 + 3 P2 全部折毕；§4 十条正典锚 17 句程序化对撞全中（grep -qF 17/17）。
- **tooling**: scan-ch6-casegua.mjs — 64 卦 × 6 单动爻位案卦扫描器（官鬼独发+回头关系+暗動位+空亡过滤）。

## 2026-07-18 (续七) - 完成温病资料 365 段显式引文校勘

- 对 `47-温病-卫气营血三焦方证条文.md` 抽取 365 段显式引文：89 段原字符、159 段规范化、30 段省略分段命中，87 段非连续命中人工定位；另有 13 段机械命中兼特殊归属裁决，待人工 0；6,176 项审计 0 fail。
- 确认“肺经气分”“撑不死的痢疾”两处参考稿错误；拒绝把 `A1J8` 全局映射为“䐜”，逐出现位置还原 䐜/撑、㿗、䗪虫和 𤺏。
- 将《湿热病篇》复合传承中的后世按语、具名转引与薛氏文本分层，保留《温热论》版本异文；`nihaisha-nishi-tcm` 本批未提供独立校勘依据。中央来源库更新为 11 组、270 文件，下一批进入 ref48《医学衷中参西录》。

## 2026-07-18 (续六) - 完成《医学心悟》357 段显式引文校勘

- 对 `46-医家-医学心悟要义.md` 抽取 357 段显式引文：82 段原字符、150 段规范化、8 段省略分段命中，117 段人工形态裁决，待人工 0；5,481 项审计 0 fail。
- 逐条复核并冻结 95 条近似段落定位，另作 22 条特殊裁决；识别 15 条现代编辑语和 1 条《伤寒论》外部用语，所有记录保持 product blocked。
- 可识别底本的公共整理文本支持“擀”“或救十中之一二”“喜冷饮食”和“耆”，据此修正两处整理稿文字并记录两类本地/公共转录污染。中央来源库更新为 11 组、269 文件，下一批进入 ref47 温病资料。
