...
| 2026-07-18 | VAL-TCM-018 | `audit:tcm-classic-ref48-quotes`；本地《医学衷中参西录》《素问》《灵枢》《难经》《伤寒论》《金匮要略》《神农本草经》；中醫笈成/Wikisource/CText/书目公共见证 | 256 段为 75 原字符、69 规范化、5 省略分段、107 人工形态裁决；另有 13 段机械命中兼特殊归属裁决，0 待办；3 条参考修正、16 条外部经典、19 条后世具名层、7 条现代编辑语、1 条 OCR 裁决；4,591 项 0 fail，全部 blocked |
