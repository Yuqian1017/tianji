...
| VAL-TCM-001 | P0 | 中医 | 当前 app 中具体药味/剂量/穴位/艾灸与图像推断 | 医疗/安全 | V4+V5 | in_progress | 旧 34 题、9 调养方案、28 药物标签、22 计量项、30 去重穴位已归档；新 blocked candidate core 均未导入，但旧 `tcm-data`/望诊仍有未授证传统诊断与食疗文字；下一步核验 `15-30` 中药方剂及食疗养生解释 |
| VAL-TCM-002 | P0 | 中医 | Skill v3 安全表、毒性、妊娠、配伍、剂量、外治、病种红线与诊断外推 | 医疗/来源 | V4 | in_progress | 导入、法定毒性及五个高风险候选层已通过来源/阻断审计；现行药典正文、完整中药/方剂、逐穴定位正文、部分监管现状和食疗解释仍待核验 |
