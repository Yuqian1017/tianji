...
| VAL-TCM-001 | P0 | 中医 | 当前 app 中具体药味/剂量/穴位/艾灸与图像推断 | 医疗/安全 | V4+V5 | in_progress | 旧 34 题、9 调养方案、28 药物标签、22 计量项、30 去重穴位已归档；新 blocked candidate core 均未导入，但旧 `tcm-data`/望诊仍有未授证传统诊断与食疗文字；下一步核验食疗、药食两用及养生解释 |
| VAL-TCM-002 | P0 | 中医 | Skill v3 安全表、毒性、妊娠、配伍、剂量、外治、病种红线与诊断外推 | 医疗/来源 | V4 | in_progress | 导入、法定毒性及七个高风险候选层已通过来源/阻断审计；现行药典正文、逐药逐方组成/剂量、逐穴定位正文、部分监管现状和食疗解释仍待核验 |
...
| VAL-TCM-009 | P0 | 中医 | `24-30` 方剂总论、正方、附方、场景选方与现代适应证 | 医疗/来源/身份/安全/疗效 | V1+现代官方 comparator | pass | 820 条非空行、8 表/171 表格行、81 标题、186 个格式化定义、522 条重叠窄风险视图和 20 finding 共 11,395 项 0 fail；182 个教材正方逐分册计数匹配，另有 4 个经典锚点；附方尚未全部实体化，全部方名、组成、剂量、给药、毒性、急症、妊娠和现代适应证字段 blocked |
| VAL-TCM-010 | P0 | 中医 | `42-48` 经典、医家、温病、食疗、药食两用与旧食疗 runtime | 医疗/来源/食品身份/安全/疗效 | V1+现代官方 comparator | pass | 1,142 条非空行、8 表/79 表格行、145 标题、603 条重叠窄风险视图和 20 finding 共 14,281 项 0 fail；A级/食疗级/药食两用均为来源自述，当前 106 项目录未逐物质裁决；旧 `tcm-data` 无 importer，八字健康食疗 runtime blocked，全部候选 blocked |
...
| 2026-07-10 | VAL-TCM-009 | `audit:tcm-formula-catalog`；NMPA/FDA/NCCIH/NLM/CDC/MedlinePlus 与中国药监 comparator | `24-30` 的 820 条非空行、8 表/171 表格行、81 标题、186 个格式化定义、522 条重叠窄风险视图和 20 finding 共 11,395 项 0 fail；全部 blocked，84 个运行时/相邻文件未导入该 core/finding ID |
