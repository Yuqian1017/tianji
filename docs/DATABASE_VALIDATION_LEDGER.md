...
| VAL-XIANG-001 | P1 | 面相/手相 | MediaPipe 几何、问卷外观与人格/职业/运势解释 | 观测可靠性+来源忠实性 | V3+V5 | in_progress | 运行时只保留几何、位置和用户/视觉外观描述；五行面型/手型、三停、掌纹与丘位解释全部 `not_validated`，人格、职业、能力、财富、关系、现实运势及医疗推断 blocked；继续验证几何阈值和传统来源 |
