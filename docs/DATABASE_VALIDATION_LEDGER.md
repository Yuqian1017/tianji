...
| VAL-TCM-001 | P0 | 中医 | 当前 app 中具体药味/剂量/穴位/艾灸与图像推断 | 医疗/安全 | V4+V5 | in_progress | 旧 34 题、9 调养方案、28 药物标签、22 计量项、30 去重穴位已归档；新 blocked candidate core 均未导入，但旧 `tcm-data`/望诊仍有未授证传统诊断与食疗文字；下一步核验 `24-30` 方剂及食疗养生解释 |
