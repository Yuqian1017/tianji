...
日期：2026-07-10
结论：通过“剩余 reference 完整 inventory、重点食疗/医疗风险裁决和产品阻断”门槛；**未通过逐条经典校勘、现行食药物质目录、食疗剂量或临床疗效授证**。
...
3. “药食两用”不等于已核入当前 106 项食药物质目录；还需逐物质核中文名、拉丁名、可食部位、加工、限量和人群。
...
TCM Skill 的 50 个 reference 已全部进入逐批完整 inventory。下一步转为中医运行时语义收尾：逐项裁决旧 `tcm-data.js`、八字健康历史 data、望诊追问和所有仍可见食疗/诊断文字；同时继续取得适用现行药典、106 项食药物质明细、逐穴定位与逐药逐方正文。全库验证总门槛继续保持开启。
