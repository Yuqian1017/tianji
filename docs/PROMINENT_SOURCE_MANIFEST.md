...
| CENTRAL-SOURCE-LIBRARY | `database/sources/source-library.json` | 11 个来源组、267 个文件的角色、canonical 路径、字节数、SHA256 与镜像关系 | 全项目统一参考文献和典籍入口 | 索引完整不授证内容正确性；正文不复制，迁移必须保留兼容映射 |
